    ...
    $gitHubTemplateUri='https://raw.githubusercontent.com/danialonso/arm/master/logAnalyticsWorkspace.json'
    $gitHubLogAnalyticsAgentUri='https://raw.githubusercontent.com/danialonso/arm/master/oms-daemonset.yaml'
